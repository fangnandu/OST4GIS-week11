var INSERT = true;
var APIKEY = "dc4287f9a5d6494b312806728d09a48c50e99acf";
...
// 1. AJAX (which is perhaps more error prone, though more general!)
/*
$.ajax("https://moradology.carto.com/api/v2/sql?q=SELECT * FROM pizza_ratings&api_key=API_KEY").done(function(data) {
  console.log(data);
});
*/
